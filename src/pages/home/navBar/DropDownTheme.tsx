...
export const DropDownTheme = () => {
  ...
  return (
    <>
      <DropdownMenu>
        <DropdownMenuTrigger className="bg-beckground flex h-[20px] w-[20px] items-center justify-center">
          {theme !== "light" ? (
        ...
        <DropdownMenuContent className="background flex w-[100px] cursor-pointer flex-col items-center justify-center border-2 border-chart-1 bg-background">
